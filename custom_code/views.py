...
def microlensing_rescaled_prob_view(request):
    ...
    microlensing_objects1 = MicrolensingRadarData.objects.filter(id__in=distinct_ids).order_by('-average_master_probability').distinct()[:40]
