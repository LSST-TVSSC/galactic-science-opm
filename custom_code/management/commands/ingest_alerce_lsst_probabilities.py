...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if len(target_list) == 0:
            print(
                f"Target list for name '{options['target_name_contains']}' was empty. Stopping."
            )
            return
        ...
        for target in target_list:
            ...
            try:
                ...
                prob_class3 = float(
                    bogus_prob[bogus_prob["class_name"] == "bogus"]["probability"].iloc[
                        0
                    ]
                )
            except:
            ...
            try:
                ...
                if len(r.content) > 2:
                    ...
                    print(
                        target.name,
                        "microlensing prob fink ",
                        np.max(new_pdf_fink["d:mulens"]),
                    )
                else:
