...
Can also be run in local directory, because nothing django related should be used in these tests:
...
This will already run the management command `seed_e2e_data` which clears the 
